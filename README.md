...
<img src="./assets/banner.svg" width="100%" alt="Luke Cline — Beyond Norme Inc." />
...
![Profile Views](https://komarev.com/ghpvc/?username=luke-cline&color=7A5C45&style=flat-square&label=PROFILE+VIEWS)
&nbsp;
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A0806?style=flat-square&logo=linkedin&logoColor=C9AE8A)](https://linkedin.com/in/YOUR_LINKEDIN)
&nbsp;
[![X](https://img.shields.io/badge/%F0%9D%95%8F-0A0806?style=flat-square&logo=x&logoColor=C9AE8A)](https://x.com/BeyondNorme)
&nbsp;
![Location](https://img.shields.io/badge/Los%20Angeles%2C%20CA-0A0806?style=flat-square&logo=googlemaps&logoColor=7A5C45)
&nbsp;
...
║                                                                              ║
║   CORE STACK    →  Next.js · TypeScript · Supabase · Vercel Edge             ║
║   MOBILE        →  React Native · Expo EAS                                   ║
║   PAYMENTS      →  Stripe · Gumroad · Crypto rails                           ║
...
Every migration written by hand. No ORM. No generated schemas. 100+ tables with Row Level Security enforced at the database level — not the application. Foreign keys, triggers, functions, performance indexes. Every query path designed before a single frontend line was written.

**AI Pipeline — multi-provider, multi-model**

Claude, Groq, and OpenAI — all proxied server-side so no API key ever touches the client. Fail-closed logic: if the reconciliation audit hasn't passed, the AI won't answer. Structured output contracts, fallback logic, latency optimization. Not a ChatGPT wrapper. A multi-model orchestration engine.
...
Stripe + Gumroad + crypto payment rails — all through webhook handlers with idempotency, retry logic, and audit trails. Each payment event flows through a billing pipeline that updates the database, sends confirmation emails, and syncs internal accounting.

**3D Intelligence Visualization**

Three.js + react-force-graph-3d for spatial visualization of enterprise data — relationship mapping, entity clustering, pattern detection. Not a chart. A spatial intelligence layer.
...
║      └────────────────────────────────────────────────────────┘    ║
║                                                                      ║
║   STATUS:  active pilot · enterprise market · compounding           ║
║                                                                      ║
╚══════════════════════════════════════════════════════════════════════╝
```
...
## ☕ BEYOND NORME — Operator Platform

> **A closed-loop execution environment. AI-native from the schema up.**
...
![TypeScript](https://img.shields.io/badge/TypeScript-0A0806?style=for-the-badge&logo=typescript&logoColor=C9AE8A)
![JavaScript](https://img.shields.io/badge/JavaScript-0A0806?style=for-the-badge&logo=javascript&logoColor=F7DF1E)
![Python](https://img.shields.io/badge/Python-0A0806?style=for-the-badge&logo=python&logoColor=7A5C45)
![SQL](https://img.shields.io/badge/PLpgSQL-0A0806?style=for-the-badge&logo=postgresql&logoColor=C9AE8A)
![HTML5](https://img.shields.io/badge/HTML5-0A0806?style=for-the-badge&logo=html5&logoColor=E34F26)
![CSS3](https://img.shields.io/badge/CSS3-0A0806?style=for-the-badge&logo=css3&logoColor=1572B6)
![Bash](https://img.shields.io/badge/Bash-0A0806?style=for-the-badge&logo=gnubash&logoColor=C9AE8A)

### Frontend & Framework

![Next.js](https://img.shields.io/badge/Next.js-0A0806?style=for-the-badge&logo=nextdotjs&logoColor=C9AE8A)
![React](https://img.shields.io/badge/React-0A0806?style=for-the-badge&logo=react&logoColor=61DAFB)
![Tailwind CSS](https://img.shields.io/badge/Tailwind-0A0806?style=for-the-badge&logo=tailwindcss&logoColor=06B6D4)
![Framer Motion](https://img.shields.io/badge/Framer_Motion-0A0806?style=for-the-badge&logo=framer&logoColor=7A5C45)
![Radix UI](https://img.shields.io/badge/Radix_UI-0A0806?style=for-the-badge&logo=radixui&logoColor=C9AE8A)
![shadcn/ui](https://img.shields.io/badge/shadcn%2Fui-0A0806?style=for-the-badge&logo=shadcnui&logoColor=F5F1E8)

### Backend & Database

![Supabase](https://img.shields.io/badge/Supabase-0A0806?style=for-the-badge&logo=supabase&logoColor=3ECF8E)
![PostgreSQL](https://img.shields.io/badge/PostgreSQL-0A0806?style=for-the-badge&logo=postgresql&logoColor=C9AE8A)
![Node.js](https://img.shields.io/badge/Node.js-0A0806?style=for-the-badge&logo=nodedotjs&logoColor=3ECF8E)
![Express](https://img.shields.io/badge/Express-0A0806?style=for-the-badge&logo=express&logoColor=7A5C45)
![Prisma](https://img.shields.io/badge/Prisma-0A0806?style=for-the-badge&logo=prisma&logoColor=C9AE8A)
![Redis](https://img.shields.io/badge/Redis-0A0806?style=for-the-badge&logo=redis&logoColor=FF4438)

### Mobile

![React Native](https://img.shields.io/badge/React_Native-0A0806?style=for-the-badge&logo=react&logoColor=61DAFB)
![Expo](https://img.shields.io/badge/Expo_EAS-0A0806?style=for-the-badge&logo=expo&logoColor=C9AE8A)

### AI / Intelligence

![Anthropic](https://img.shields.io/badge/Claude-0A0806?style=for-the-badge&logo=anthropic&logoColor=C9AE8A)
![OpenAI](https://img.shields.io/badge/OpenAI-0A0806?style=for-the-badge&logo=openai&logoColor=7A5C45)
![Groq](https://img.shields.io/badge/Groq-0A0806?style=for-the-badge&logoColor=C9AE8A)
![Deepgram](https://img.shields.io/badge/Deepgram-0A0806?style=for-the-badge&logoColor=7A5C45)
![LangChain](https://img.shields.io/badge/LangChain-0A0806?style=for-the-badge&logo=langchain&logoColor=C9AE8A)

### Infrastructure & DevOps

![Vercel](https://img.shields.io/badge/Vercel-0A0806?style=for-the-badge&logo=vercel&logoColor=C9AE8A)
![GitHub Actions](https://img.shields.io/badge/GitHub_Actions-0A0806?style=for-the-badge&logo=githubactions&logoColor=7A5C45)
![Docker](https://img.shields.io/badge/Docker-0A0806?style=for-the-badge&logo=docker&logoColor=2496ED)
![AWS S3](https://img.shields.io/badge/AWS_S3-0A0806?style=for-the-badge&logo=amazons3&logoColor=C9AE8A)
![Upstash](https://img.shields.io/badge/Upstash-0A0806?style=for-the-badge&logoColor=7A5C45)

### Commerce & Payments

![Stripe](https://img.shields.io/badge/Stripe-0A0806?style=for-the-badge&logo=stripe&logoColor=635BFF)
![Gumroad](https://img.shields.io/badge/Gumroad-0A0806?style=for-the-badge&logo=gumroad&logoColor=FF90E8)

### Editor & Environment

![VS Code](https://img.shields.io/badge/VS_Code-0A0806?style=for-the-badge&logo=visualstudiocode&logoColor=007ACC)
![Cursor](https://img.shields.io/badge/Cursor-0A0806?style=for-the-badge&logoColor=C9AE8A)
![macOS](https://img.shields.io/badge/macOS-0A0806?style=for-the-badge&logo=apple&logoColor=7A5C45)
![Warp](https://img.shields.io/badge/Warp-0A0806?style=for-the-badge&logo=warp&logoColor=C9AE8A)
![Figma](https://img.shields.io/badge/Figma-0A0806?style=for-the-badge&logo=figma&logoColor=7A5C45)
...
<img src="https://github-readme-activity-graph.vercel.app/graph?username=luke-cline&bg_color=0A0806&color=C9AE8A&line=7A5C45&point=F5F1E8&area=true&area_color=2B1810&hide_border=true&radius=4" width="100%" />
